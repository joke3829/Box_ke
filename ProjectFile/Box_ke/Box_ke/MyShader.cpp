...
CFullScreenTextrueRenderShaderDX11::CFullScreenTextrueRenderShaderDX11(ID3D11Device* device)
{
	CreateVSAndInputLayout(device);
	CreatePS(device);
}

void CFullScreenTextrueRenderShaderDX11::ShaderReCompile(void* device)
{
	ID3D11Device* td = reinterpret_cast<ID3D11Device*>(device);
...
void CFullScreenTextrueRenderShaderDX11::CreateVSAndInputLayout(ID3D11Device* device)
{
...
void CFullScreenTextrueRenderShaderDX11::CreatePS(ID3D11Device* device)
{
	ComPtr<ID3DBlob> pBlob = CompileHLSL(L"Shaders\\TextureRenderShader.hlsl", "TextureRenderPS", "ps_5_0");
	HRESULT hResult = device->CreatePixelShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), nullptr, m_PS.GetAddressOf());
...
CLuminanceShaderDX11::CLuminanceShaderDX11(ID3D11Device* device)
{
	CreateVSAndInputLayout(device);
	CreatePS(device);
}

void CLuminanceShaderDX11::ShaderReCompile(void* device)
{
	ID3D11Device* td = reinterpret_cast<ID3D11Device*>(device);
...
void CLuminanceShaderDX11::CreateVSAndInputLayout(ID3D11Device* device)
{
	ComPtr<ID3DBlob> pBlob = CompileHLSL(L"Shaders\\TextureRenderShader.hlsl", "TextureRenderVS", "vs_5_0");
	HRESULT hResult = device->CreateVertexShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), nullptr, m_VS.GetAddressOf());
...
void CLuminanceShaderDX11::CreatePS(ID3D11Device* device)
{
	ComPtr<ID3DBlob> pBlob = CompileHLSL(L"Shaders\\TextureRenderShader.hlsl", "LuminancePS", "ps_5_0");
	HRESULT hResult = device->CreatePixelShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), nullptr, m_PS.GetAddressOf());
...
CTextureToneMappingShaderDX11::CTextureToneMappingShaderDX11(ID3D11Device* device)
{
	CreateVSAndInputLayout(device);
	CreatePS(device);
}

void CTextureToneMappingShaderDX11::ShaderReCompile(void* device)
{
	ID3D11Device* td = reinterpret_cast<ID3D11Device*>(device);
...
void CTextureToneMappingShaderDX11::CreateVSAndInputLayout(ID3D11Device* device)
{
	ComPtr<ID3DBlob> pBlob = CompileHLSL(L"Shaders\\TextureRenderShader.hlsl", "TextureRenderVS", "vs_5_0");
	HRESULT hResult = device->CreateVertexShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), nullptr, m_VS.GetAddressOf());
...
void CTextureToneMappingShaderDX11::CreatePS(ID3D11Device* device)
{
	ComPtr<ID3DBlob> pBlob = CompileHLSL(L"Shaders\\TextureRenderShader.hlsl", "TextureToneMapping", "ps_5_0");
	HRESULT hResult = device->CreatePixelShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), nullptr, m_PS.GetAddressOf());
...
CShadowMapShaderDX11::CShadowMapShaderDX11(ID3D11Device* device)
{
	CreateVSAndInputLayout(device);
	CreatePS(device);
}

void CShadowMapShaderDX11::ShaderReCompile(void* device)
{
	ID3D11Device* td = reinterpret_cast<ID3D11Device*>(device);
...
void CShadowMapShaderDX11::CreateVSAndInputLayout(ID3D11Device* device)
{
	ComPtr<ID3DBlob> pBlob = CompileHLSL(L"Shaders\\ShadowMap.hlsl", "ShadowMapVS", "vs_5_0");
	HRESULT hResult = device->CreateVertexShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), nullptr, m_VS.GetAddressOf());
...
void CShadowMapShaderDX11::CreatePS(ID3D11Device* device)
{
	ComPtr<ID3DBlob> pBlob = CompileHLSL(L"Shaders\\ShadowMap.hlsl", "ShadowMapPS", "ps_5_0");
	HRESULT hResult = device->CreatePixelShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), nullptr, m_PS.GetAddressOf());
...
CVerticalGaussianBlurShaderDX11::CVerticalGaussianBlurShaderDX11(ID3D11Device* device)
{
	CreateCS(device);
}


void CVerticalGaussianBlurShaderDX11::CreateCS(ID3D11Device* device)
{
	ComPtr<ID3DBlob> pBlob = CompileHLSL(L"Shaders\\GaussianBlurShader.hlsl", "VerticalGaussianBlur", "cs_5_0");
	HRESULT hResult = device->CreateComputeShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), nullptr, m_CS.GetAddressOf());

	if (FAILED(hResult)) {
		MessageBoxA(0, "Failed CreateComputeShader()", "Fatal Error", MB_OK);
		PostQuitMessage(0);
	}
}


CHorizonGaussianBlurShaderDX11::CHorizonGaussianBlurShaderDX11(ID3D11Device* device)
{
	CreateCS(device);
}


void CHorizonGaussianBlurShaderDX11::CreateCS(ID3D11Device* device)
{
	ComPtr<ID3DBlob> pBlob = CompileHLSL(L"Shaders\\GaussianBlurShader.hlsl", "HorizonGaussianBlur", "cs_5_0");
	HRESULT hResult = device->CreateComputeShader(pBlob->GetBufferPointer(), pBlob->GetBufferSize(), nullptr, m_CS.GetAddressOf());
